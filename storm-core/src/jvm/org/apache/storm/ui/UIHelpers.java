...
public class UIHelpers {
    ...
    public static APersistentMap jsonResponse(Object data, String callback) {
        return jsonResponse(data, callback, true, null, null);
    }

    public static APersistentMap jsonResponse(Object data, String callback, Long status) {
        return jsonResponse(data, callback, true, status, null);
    }

    public static APersistentMap jsonResponse(Object data, String callback, Map headers) {
        return jsonResponse(data, callback, true, null, headers);
    }

    // here status argument type is Long,
    public static APersistentMap jsonResponse(Object data, String callback, boolean needSerialize, Long status, Map headers) {
