...
(deftest test-list-log-files
  (testing "list-log-files filter selects the correct log files to return"
    (let [attrs (make-array FileAttribute 0)
          ...
          expected-all (UIHelpers/jsonResponse '("topoA/port1/worker.log" "topoA/port2/worker.log"
                                         "topoB/port1/worker.log")
                         {"Access-Control-Allow-Origin" origin
                          "Access-Control-Allow-Credentials" "true"})
          expected-filter-port (UIHelpers/jsonResponse '("topoA/port1/worker.log" "topoB/port1/worker.log")
                                 {"Access-Control-Allow-Origin" origin
                                  "Access-Control-Allow-Credentials" "true"})
          expected-filter-topoId (UIHelpers/jsonResponse '("topoB/port1/worker.log")
                                   {"Access-Control-Allow-Origin" origin
                                    "Access-Control-Allow-Credentials" "true"})
